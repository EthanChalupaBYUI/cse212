...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (current != null)
        {
            ...
            {
                // Found the node with the value, now remove it
                ...
                // Break out of the loop once the node is removed
                break;
            }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        // Traverse the list to find and replace all instances of oldValue
        while (current != null)
        {
            if (current.Value == oldValue)
            {
                current.Value = newValue; // Replace the value
            }
